...
Future<dynamic> main(final context) async {
  ...
  try {
    ...
    await users.updatePhoneVerification(userId: id, phoneVerification: true);
    ...
    return context.res.json({
      'title': 'Mobile phone has been verified',
      'message': '${user.data['readable_name']} mobile phone has been verified',
      'severity': 'success',
    });
  } on AppwriteException catch (e) {
    context.error('Could not verify users phone number: $e');
    return context.res.json({
      'message': 'Could not verify users phone number',
      'error': e.message,
    });
  }
}
